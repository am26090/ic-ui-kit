...
<Canvas withSource="none">
  <Story name="Large Data Set">{LargeDataSet()}</Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Column header truncation">{HeaderTruncation()}</Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Loading State" height="360px">
    {Loading()}
  </Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Updating data">{UpdatingData()}</Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Slotted pagination bar">{SlottedPagination()}</Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Data truncation tooltip">{TruncationTooltip()}</Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Text Wrap">{TruncationTextWrap()}</Story>
</Canvas>
...
<Canvas withSource="none">
  <Story name="Table sizing and column width">{DataTableSizing()}</Story>
</Canvas>
...
The cell data can contain an `actionElement` which can be a string containing any html to be rendered. The `actionElement` will be displayed to the right of the cell data. An `actionOnClick` can be specified for the `actionElement`. This should be a function to be run when the `actionElement` is clicked.
...
<Canvas withSource="none">
  <Story name="Missing cell data" parameters={{ loki: { skip: true } }}>
    {MissingCellData()}
  </Story>
</Canvas>
